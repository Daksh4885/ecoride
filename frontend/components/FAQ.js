...
const faqs = [
  ...
  { q: 'What is the fare for one-way taxi?', a: 'Sedan: ₹15/km, SUV: ₹20/km, Innova: ₹21/km, Innova Crysta: ₹24/km. Minimum distance is 130 km for one-way trips. Driver batta, toll, and permit charges are extra where applicable.' },
  ...
  { q: 'Which cities do you operate in?', a: 'We operate across all major cities in South India including Tamil Nadu, Karnataka, Andhra Pradesh, and Kerala. Major cities include Chennai, Bangalore, Hyderabad, Kochi, Trivandrum, Vijayawada, Coimbatore, and Madurai. We cover 200+ cities.' },
